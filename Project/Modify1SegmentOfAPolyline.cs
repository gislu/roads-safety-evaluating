...
namespace GeometryAndSR
{
    ...
    public sealed class Modify1SegmentOfAPolyline : BaseTool
    {
        ...
        public override void OnMouseDown(int Button, int Shift, int X, int Y)
        {
            ...
            {
                MessageBox.Show("请选择要素（在要移动的线段处点选）！！", "信息提示", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
            IGeometryCollection polyline = m_selectedFeature.Shape as IGeometryCollection;
            ISegmentCollection segments = Modify1Segment(polyline, 1, 5, 5);
           if (segments != null) UpdateFeature(m_selectedFeature, segments);
